...
- **Migrations:** 45 files under `supabase/migrations/` using three naming schemes (`001_`, `008b_`, `020_`, and timestamped), including two `remote_schema` dumps, so drift between the folder and production is expected.

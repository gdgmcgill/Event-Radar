...
| REFAC-11 | Phase 5 | Partial (05-04, 05-05, 05-06). Delivered: validated config with the env non-null census empty (05-04, 05-05); the proxy is advisory and fails closed, with onboarding read from the database (05-05, e2d6d3a); the handler ring on 14 events-family write arms, which now refuse banned, profile-less and un-onboarded callers themselves (05-06, aa50ff6). Open: the handler ring on the remaining 25 write arms lands in 05-07 |

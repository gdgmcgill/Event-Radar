      ...
      <DialogContent className="max-w-md border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100">
            ...
            Suspend {itemType === "event" ? "Event" : "Club"}
          </DialogTitle>
          <DialogDescription className="text-zinc-500 dark:text-zinc-400">
            This will hide the {itemType} from public view. The creator will be
            notified and can submit an appeal.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            ...
            . Please provide a reason so the organizer understands what needs to
            change.
          </p>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full px-3 py-2 text-sm rounded-lg border border-zinc-200 bg-white text-zinc-900 focus:outline-none focus:ring-2 focus:ring-amber-500/20 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
            >
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
              Details <span className="text-amber-500">*</span>
            </label>
            <Textarea
              value={message}
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500">
              This message will be visible to the organizer. Keep it under 500
              characters.
            </p>
          </div>
        </div>
        ...
        <DialogFooter className="gap-2 sm:gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 justify-center h-9 px-4 text-sm font-medium rounded-md bg-amber-500 text-white hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {submitting ? (
